...
function objectify(thing) {
  if (!_chunk3I4KH26Ecjs.isObject.call(void 0, thing)) {
    return {};
  }
  return thing;
}
...
function getMediaTypeExamples(mediaType, mediaTypeObject, opts = {}) {
  ...
  if (mediaTypeObject.schema) {
    if (!_chunk3I4KH26Ecjs.matches_mimetype_default.xml(mediaType)) {
      return [
        {
...
var isJSON = _chunk3I4KH26Ecjs.matches_mimetype_default.json;
function buildHeadersSchema(response, opts) {
  ...
  Object.keys(headers).forEach((key) => {
    if (headers[key] && headers[key].schema) {
      ...
      headersSchema.properties[key] = _chunk3I4KH26Ecjs.toJSONSchema.call(void 0, header.schema, {
...
function getResponseAsJSONSchema(operation, api, statusCode, opts) {
  ...
  function getPreferredSchema(content) {
    ...
    for (let i = 0; i < contentTypes.length; i++) {
      if (isJSON(contentTypes[i])) {
        return _chunk3I4KH26Ecjs.toJSONSchema.call(void 0, _chunk3I4KH26Ecjs.cloneObject.call(void 0, content[contentTypes[i]].schema), {
          addEnumsToDescriptions: true,
          refLogger,
          transformer: opts.transformer
        });
    ...
    return _chunk3I4KH26Ecjs.toJSONSchema.call(void 0, _chunk3I4KH26Ecjs.cloneObject.call(void 0, content[contentType].schema), {
      addEnumsToDescriptions: true,
      refLogger,
      transformer: opts.transformer
    });
  ...
  if (foundSchema) {
    const schema = _chunk3I4KH26Ecjs.cloneObject.call(void 0, foundSchema);
    const schemaWrapper = {
      ...
      schema: _chunk3I4KH26Ecjs.isPrimitive.call(void 0, schema) ? schema : {
        ...schema,
        $schema: _chunk3I4KH26Ecjs.getSchemaVersionString.call(void 0, schema, api)
      },
      label: "Response body"
    };
...
var Operation = class {
  ...
  getContentType() {
    ...
    types.forEach((t) => {
      if (_chunk3I4KH26Ecjs.matches_mimetype_default.json(t)) {
        this.contentType = t;
      }
    });
    return this.contentType;
  ...
  isFormUrlEncoded() {
    return _chunk3I4KH26Ecjs.matches_mimetype_default.formUrlEncoded(this.getContentType());
  }
  isMultipart() {
    return _chunk3I4KH26Ecjs.matches_mimetype_default.multipart(this.getContentType());
  }
  isJson() {
    return _chunk3I4KH26Ecjs.matches_mimetype_default.json(this.getContentType());
  }
  isXml() {
    return _chunk3I4KH26Ecjs.matches_mimetype_default.xml(this.getContentType());
  }
  /**
  ...
  getParametersAsJSONSchema(opts = {}) {
    return _chunk3I4KH26Ecjs.getParametersAsJSONSchema.call(void 0, this, this.api, {
  ...
  getRequestBody(mediaType) {
    ...
    mediaTypes.forEach((mt) => {
      if (!availableMediaType && _chunk3I4KH26Ecjs.matches_mimetype_default.json(mt)) {
 ...
 */
//# sourceMappingURL=chunk-ZXCOYYXC.cjs.map