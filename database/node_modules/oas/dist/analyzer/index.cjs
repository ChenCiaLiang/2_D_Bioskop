...
var _chunkYIKOQY6Kcjs = require('../chunk-YIKOQY6K.cjs');
require('../chunk-ZXCOYYXC.cjs');
require('../chunk-VIIXOUMH.cjs');
require('../chunk-3I4KH26E.cjs');
...
async function circularRefs(definition) {
  const oas = new (0, _chunkYIKOQY6Kcjs.Oas)(JSON.parse(JSON.stringify(definition)));
